  ...
  return (
    <div>
      <header className="grid grid-cols-3 bg-white h-14">
        ...
        <button onClick={toPage("home")} className='rounded-lg shadow-lg bg-red-400 m-2 p-1 text-sm font-medium'>Home</button>
        <button onClick={toPage("create")} className='rounded-lg shadow-lg bg-yellow-300 m-2 p-1 text-sm font-medium'>Create</button>
      </header>
      {getContent()}
    </div>
  )
