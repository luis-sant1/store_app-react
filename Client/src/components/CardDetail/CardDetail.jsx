            ...
            <div className="inf">
                <div className="max-w-98 max-h-98 bg-secondary flex flex-col items-center justify-center m-8">
                    ...
                    <div className='grid grid-cols-2 m-4 gap-20'>
                        ...
                        <button className='w-full rounded-lg shadow-lg bg-green-50 m-2 p-1 text-sm font-medium' onClick={funUpDate("update",props.dataDetail._id, props.dataDetail )} >Actualizar</button>
                    </div>
                </div>
            </div>:
            <div className="">
