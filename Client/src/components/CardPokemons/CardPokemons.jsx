...
export default function CardPokemons (props){
    ...
    return(
        ...
        <div className="flex mr-auto ml-auto">
            ...
            <button className='flex justify-center items-center text-center content-center mb-6 mr-6 ml-6 sm:ml-auto sm:mr-auto md:mr-auto md:ml-auto' onClick={(e)=>props.openDetail(e, props.data)}>
